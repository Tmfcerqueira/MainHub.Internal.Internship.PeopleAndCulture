using MainHub.Internal.PeopleAndCulture.TimesheetManagement.API.Feature;
...
//Inject TimesheetManagementDbContext and Repository
builder.Services.AddDbContext<TimesheetManagementDbContext>(options =>
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "An ASP.NET Core Web API to create Timesheets and its Activities"
    });
...
app.MapHealthChecks("/api/timesheet/healthcheck");
