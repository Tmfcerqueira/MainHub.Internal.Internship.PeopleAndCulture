...
{
    public partial class PeopleManagementMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CCVal = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "NoCCExpireDate"),
                    ...
                    ChangedBy = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "No Changes"),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Active")
                },
                constraints: table =>
                {
                    table.PrimaryKey("Collaborator_Id", x => x.Id);
                    table.UniqueConstraint("AK_Collaborators_CCNumber", x => x.CCNumber);
                    table.UniqueConstraint("AK_Collaborators_SSNumber", x => x.SSNumber);
                    table.UniqueConstraint("AK_Collaborators_TaxNumber", x => x.TaxNumber);
