...
namespace MainHub.Internal.PeopleAndCulture.Migrations
{
    ...
    [Migration("20230530093440_SkillHub6")]
    partial class SkillHub6
    {
            ...
            modelBuilder.Entity("MainHub.Internal.PeopleAndCulture.AbsentManagement.Database.Models.Absence", b =>
                {
                    ...
                    b.Property<int?>("AbsenceTypeHistoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AbsenceTypeHistoryId");
            ...
            modelBuilder.Entity("MainHub.Internal.PeopleAndCulture.AbsentManagement.Database.Models.AbsenceHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ActionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 30, 10, 34, 40, 224, DateTimeKind.Local).AddTicks(669));
                    ...
                    b.HasAlternateKey("AbsenceGuid")
                        .HasName("AK_AbsenceHistory_Guid");
            ...
            modelBuilder.Entity("MainHub.Internal.PeopleAndCulture.AbsentManagement.Database.Models.AbsenceTypeHistory", b =>
                {
                    ...
                    b.Property<DateTime>("ActionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 30, 10, 34, 40, 224, DateTimeKind.Local).AddTicks(1778));
                    ...
                    b.HasAlternateKey("TypeGuid")
                        .HasName("AK_AbsenceTypeHistory_Guid");
            ...
            modelBuilder.Entity("MainHub.Internal.PeopleAndCulture.AbsentManagement.Database.Models.Absence", b =>
                {
                    ...
                    b.HasOne("MainHub.Internal.PeopleAndCulture.AbsentManagement.Database.Models.AbsenceTypeHistory", null)
                        .WithMany("Absences")
                        .HasForeignKey("AbsenceTypeHistoryId");
