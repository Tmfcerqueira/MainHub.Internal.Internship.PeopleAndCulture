...
{
    public partial class AllUsersCalendar
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            try
            {
                _help = localizer["AllUserCalendarHelp"];
                _isLoading = false;
        ...
        async Task LoadData(SchedulerLoadDataEventArgs args)
        {
            try
            {
                ...
                result = await AbsenceRepository.GetAllAbsencesAsync(page, pageSize, ProxyModel.ApprovalStatus.Approved);
        ...
        async Task OnAppointmentSelect(SchedulerAppointmentSelectEventArgs<AbsenceModel> args)
        {
            ...
            if (args.Data.ApprovalStatus != ApprovalStatus.Draft)
            {
