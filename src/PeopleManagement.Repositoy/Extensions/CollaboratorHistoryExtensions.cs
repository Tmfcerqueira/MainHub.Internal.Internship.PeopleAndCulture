...
{
    public static class CollaboratorHistoryExtensions
    {
        public static PeopleHistoryRepoModel ToHistoryRepoModel(this CollaboratorHistory model)
        {
            return new PeopleHistoryRepoModel
            {
