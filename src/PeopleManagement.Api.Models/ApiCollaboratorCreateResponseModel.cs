...
using static MainHub.Internal.PeopleAndCulture.ApiCollaboratorHistoryResponseModel;
using static PeopleManagement.Api.Models.ApiCollaboratorResponseModel;

namespace PeopleManagement.Api.Models
{
    public class ApiCollaboratorCreateResponseModel
    {
        ...
        public ApiCollaboratorCreateResponseModel()
        {
