...
{
    public static class AllPeopleDbModelExtensions
    {
        public static AllPeopleRepoModel ToAllPeopleRepoModel(this Collaborator model)
        {
            return new AllPeopleRepoModel
            {
